    ...
    render: function() {
        return (
            <div style={FormLayoutStyles[this.props.layoutStyle]}>
                <MUIComponents.TextField fullWidth={true} onChange={this._onChange} {...this.props} placeholder={null} hintText={this.props.placeholder} floatingLabelText={this.props.label} errorText={this.props.errorText} />
            </div>
        )
    }
});